...
# Allocate 1G hugepages if the platform supports them
...
VM_NUMA_0=${VM_NUMA_0:-8G}
VM_NUMA_1=${VM_NUMA_1:-8G}
...
function run_test() {
    ...
    vng --cpus $VM_CPUS --memory $VM_MEMORY --numa $VM_NUMA_0 --numa $VM_NUMA_1 \
        --rwdir=/mnt=$guest_dir \
